...
#include <modules/game/playerControllerComponent.hpp>
...
#include <modules/camera/cameraComponent.hpp>
#include <modules/window/window.hpp>
#include <modules/link/link.hpp>
#include <modules/rendering/opengl.cpp>
...
int main() {
    ...
    std::cout << std::endl << "Press enter to start." << std::endl; std::cin.get();
    std::cout << "Initializing Dove..." << std::endl;
    
    // LibraryLoader doveLoader("test");
    // using FuncType = void(*)();
    // FuncType dream = doveLoader.getSymbol<FuncType>("buildTestDream");
    // dream();

    rendererInit();

    std::cout << "Building test dream..." << std::endl;
