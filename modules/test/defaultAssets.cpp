...
void loadDefaultAssets() {
    ...
    testShader = std::make_shared<Shader>("testShader", "../assets/shaders/TransformVertexShader.vertexshader", "../assets/shaders/TextureFragmentShader.fragmentshader");
    testShader2 = std::make_shared<Shader>("testShader2", "../assets/shaders/TransformVertexShader.vertexshader", "../assets/shaders/TextureFragmentShader.fragmentshader");
    testSkyShader = std::make_shared<Shader>("testSkyShader", "../assets/shaders/SkyVertexShader.vertexshader", "../assets/shaders/SkyboxFragmentShader.fragmentshader");
    
    testTexture = std::make_shared<Texture>("testTexture", "../assets/textures/test.png");
