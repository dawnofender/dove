...
// This class also makes it possible to serialize/deserialize objects, by assigning each thing pointer an ID.

// The base Thing class has just the bare minimum functionality, and is not meant to be observed in-world.

// This class will become less necessary later on with C++ 26 reflection
//
// please we need reflection so bad it will fix everything about this mess lol
...
// reflection would fix this. just take the first constructor and fill in the arguments with deserialized data
